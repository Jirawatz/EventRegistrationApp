...
class RegisterEditor extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.getRegister(this.props.match.params.regid);
        this.getCustomer(this.props.match.params.cid);
    ...
    saveRegister() {
        ...
        this.saveCustomer();
        var newRegister = {
            registrationid: this.state.reg.registrationid,
